...
- **Song Choice Mechanic**: After quiz completion, player picks a celebration genre (Hip-Hop, Rock, K-Pop, Funk) displayed as a 2x2 color-coded button grid. Framework built with placeholders (all genres currently play same remix).
