...
- Money rain icons: 17 transparent PNG icons covering money evolution — ancient (shells, beads, cattle, salt, tea bricks, feathers, cocoa beans, rai stone, gold bars, coins) and modern (banknotes, credit cards, modern coins, Bitcoin, yen, yuan, euro). Blue backgrounds removed via scripts/process-money-icons.cjs. White edge artifacts trimmed before background removal. Cattle icons always rendered at maximum size (72px). Currency icons (banknote, yen, yuan, euro) appear at high frequency (40% chance). A single 4-character-wide green binary matrix strip streams vertically down the screen replacing the old binary code icon images.
