...
- **3-Songs-Per-Game Reward System**: DJ quiz choice (1) + mid-party change (1) + random completion bonus (1) = 3 possible genre unlocks per game. Funk record reward delayed 5s after party start. Record reward popups require tap to dismiss (no auto-dismiss). Denial of second song change includes follow-up encouraging replay.
