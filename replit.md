...
- **Badge System**: 6 collectible badges (Double Coincidence of Wants, Debt, No Trust No Trade, The Ledger, Debt Settled, Money Scholar) with persistent tray HUD (X/6 progress), tap-to-expand panel, golden glow animation on earn, sparkle popup, and badge-centric success screen. All 6 badges are earnable on both the normal path and the smart path in a single playthrough.
  ...
  - No Trust No Trade: Awarded after brawl (Loop 1) OR during elder's stone tablet introduction (smart path)
  - The Ledger: Awarded at first Stone Tablet carving (both paths)
